...
-- Why? My current temporary solution for now (November 7 2022) for dealing with characters
-- drawing order,
--	kinda worried about how I might deal with larger character like a beast monsters...
--	Maybe "Character" ---generally used for simple characters, but for anything else, I
--	may have to make another class that act like this one.
...
-- November 15 2022 FUCKK YEAH it WOOORKs! Continue at gaming scaling(Zooming out) during
-- moving that character at different place!

	-- automate moving while making manual moving unable. atX,atY just means the last
	-- position of that base_x/y before leaving
	if timer > 0 then
